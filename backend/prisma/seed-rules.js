...
const RULES = [
  ...
  ['exclude_stopped_employees_from_payroll', 'استبعاد الموظف الموقوف من المرتبات بعد تاريخ الإيقاف', 'payroll', 'boolean', 'true', '', 25, 'all', 'الموظف الذي تم إيقافه أو إنهاء خدمته لا يدخل في كشوف المرتبات للفترات التي تبدأ بعد تاريخ الإيقاف.'],
