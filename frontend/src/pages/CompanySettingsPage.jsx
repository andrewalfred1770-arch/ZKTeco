...
import { Building2, Image as ImageIcon, Printer, Save, Loader2, Upload, Trash2 } from 'lucide-react';
...
const IMAGE_FIELDS = [
  { field: 'logo',            key: 'logo_url',             label: 'شعار الشركة (Logo)',     hint: 'يظهر في الشريط الجانبي والتقارير وكشوف المرتبات' },
  { field: 'loginBackground', key: 'login_background_url', label: 'خلفية شاشة البدء',        hint: 'تظهر في شاشة بدء التشغيل (Splash)' },
  { field: 'stamp',           key: 'stamp_url',            label: 'ختم الشركة',              hint: 'يُستخدم في مستندات الطباعة الرسمية' },
  { field: 'printHeader',     key: 'print_header_url',     label: 'رأس صفحة الطباعة',        hint: 'صورة رأس مخصصة للتقارير المطبوعة' },
];

function ImageUploader({ field, settingKey, label, hint, value, onUpload, onDelete }) {
